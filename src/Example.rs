...
fn main() -> Result<()> {
    ...
    let parser = CommandLineParser::new(
        ...
        "{fd_model fd       | D:\\Code\\ACamOperator\\models\\sface.onnx | Path to the model. Download yunet.onnx in https://github.com/opencv/opencv_zoo/tree/master/models/face_detection_yunet}",
        "{fr_model fr       | D:\\Code\\ACamOperator\\models\\yunet.onnx | Path to the face recognition model. Download the model at https://github.com/opencv/opencv_zoo/tree/master/models/face_recognition_sface}",
