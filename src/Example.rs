...
fn main() -> Result<()> {
    ...
    let parser = CommandLineParser::new(
        ...
        "{fd_model fd       | D:\\Code\\ACamOperator\\target\\debug\\face_detection_yunet_2023mar.onnx| Path to the model. Download yunet.onnx in https://github.com/opencv/opencv_zoo/tree/master/models/face_detection_yunet}",
        "{fr_model fr       | D:\\Code\\ACamOperator\\target\\debug\\face_recognition_sface_2023mar.onnx | Path to the face recognition model. Download the model at https://github.com/opencv/opencv_zoo/tree/master/models/face_recognition_sface}",
        "{score_threshold   | 0.75        | Filter out faces of score < score_threshold}",
